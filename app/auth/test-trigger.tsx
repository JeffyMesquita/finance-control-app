    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Verifique se o trigger está funcionando corretamente</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="mb-4 text-sm text-muted-foreground">
            Clique no botão abaixo para verificar se seus dados de usuário foram inseridos corretamente na tabela users.
          </p>
        ...
        <CardFooter>
          <Button onClick={checkUserInsertion} disabled={isLoading} className="w-full">
