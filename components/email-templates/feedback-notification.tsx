  ...
  >
    ...
    <div style={{ padding: "32px 24px" }}>
      ...
      {feedback.browser_info && (
        ...
        >
          ...
          <div style={{ fontSize: "12px", color: "#78350f" }}>
            ...
            <p style={{ margin: "4px 0" }}>
              <strong>Resolução:</strong> {feedback.browser_info.viewport.width}
              x{feedback.browser_info.viewport.height}
            </p>
            <p style={{ margin: "4px 0" }}>
      ...
      >
        ...
        <a
          href={`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/admin/feedbacks/${feedback.id}`}
          style={{
