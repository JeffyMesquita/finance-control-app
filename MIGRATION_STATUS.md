...
| 2026-08-04 | Official frontend E2E gate | `pnpm test:e2e:local` (preflight + `build:e2e` + Playwright matrix) | 12 tests passed: core finance, goals/savings, investments and remaining domains in Chromium, Firefox and WebKit. |
